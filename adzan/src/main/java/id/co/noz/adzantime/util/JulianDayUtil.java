package id.co.noz.adzantime.util;

import static id.co.noz.adzantime.Constants.HOURS_IN_DAY_DOUBLE;
import static id.co.noz.adzantime.Constants.MID_DAY_HOUR;
import static id.co.noz.adzantime.util.MathUtil.acosDeg;
