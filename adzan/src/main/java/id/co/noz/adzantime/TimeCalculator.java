...
import id.co.noz.adzantime.types.AngleCalculationType;
import id.co.noz.adzantime.util.JulianDayUtil;

import static id.co.noz.adzantime.Constants.ASR_RATIO_HANAFI;
import static id.co.noz.adzantime.Constants.ASR_RATIO_MAJORITY;
import static id.co.noz.adzantime.Constants.HOURS_IN_DAY;
...
import static id.co.noz.adzantime.Constants.MINUTE_IN_HOUR_DOUBLE;
import static id.co.noz.adzantime.Constants.SECOND_IN_MINUTE;
import static id.co.noz.adzantime.PrayerCalculator.asr;
import static id.co.noz.adzantime.PrayerCalculator.fajr;
import static id.co.noz.adzantime.PrayerCalculator.maghrib;
import static id.co.noz.adzantime.PrayerCalculator.sunrise;
import static id.co.noz.adzantime.PrayerCalculator.zuhr;
import static id.co.noz.adzantime.PrayerCalculator.isha;
import static id.co.noz.adzantime.types.AngleCalculationType.UMM_AL_QURA;
import static id.co.noz.adzantime.types.BaseTimeAdjustmentType.TWO_MINUTES_ZUHR;
import static id.co.noz.adzantime.util.JulianDayUtil.adjustJdHour;
